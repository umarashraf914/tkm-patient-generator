...
# ============================================================================
# SYMPTOM KEY MAPPING
# Maps internal session state keys to CSV symptom keys
# ============================================================================

# This mapping connects the existing randomizer.py session keys
# to the symptom keys in the parsed CSV data
SYMPTOM_KEY_MAP = {
    # 감기 symptom mappings
    "감기": {
        # 발현시점 (Onset)
        "onset": "감기환자_O/S_감기증상 발현시점",
        
        # 주증상 (Main symptoms)
        "fever_sev": "감기환자_감기주소증 유형_발열",
        "chills_sev": "감기환자_감기주소증 유형_오한",
        "chills_fever_alternate": "감기환자_감기주소증 유형_한열왕래",
        "snot_sev": "감기환자_감기주소증 유형_콧물 감기",
        "snot_color": "감기환자_감기주소증 유형_콧물 색",
        "nasal_congestion": "감기환자_감기주소증 유형_코막힘",
        "smell_decrease": "감기환자_감기주소증 유형_후각 감퇴",
        "sore_throat": "감기환자_감기주소증 유형_인후통",
        "sneeze_sev": "감기환자_감기주소증 유형_재채기",
        "cough_sev": "감기환자_감기주소증 유형_기침",
        "phlegm_amt": "감기환자_감기주소증 유형_담(가래) 양",
        "phlegm_color": "감기환자_감기주소증 유형_담(가래) 색",
        "body_ache": "감기환자_감기주소증 유형_몸살, 신체통, 근육통",
        "body_heavy": "감기환자_감기주소증 유형_신중(身重)",
        "headache": "감기환자_감기주소증 유형_두부, 뒷목 불편감(강도)",
        "sweat_during_cold": "감기환자_감기주소증 유형_감기 시 땀 유무",
        "shortness_of_breath": "감기환자__숨이 가쁨",
        
        # 악화/완화 요인
        "aggravating_factors": "감기환자_감기 완화요인/악화요인_감기 완화요인/악화요인",
        
        # 진찰 소견
        "lung_sound": "감기환자_한의사 진찰 및 검사소견_호흡음(폐음) 진찰",
        "throat_exam": "감기환자_한의사 진찰 및 검사소견_인후부 진찰",
        "tonsil_exam": "감기환자_한의사 진찰 및 검사소견_편도진찰",
        
        # 인구학적 정보
        "height_category": "인구학적 정보__키",
        "weight_category": "인구학적 정보__몸무게",
        "bmi_category": "인구학적 정보__체질량지수",
        "sex": "인구학적 정보__성별",
        "age_category": "인구학적 정보__나이",
        "job": "인구학적 정보__직업",
        
        # 활력징후
        "temp_category": "활력징후__체온",
        "pulse_category": "활력징후__맥박",
        "resp_category": "활력징후__호흡",
        "bp_category": "활력징후__혈압",
        
        # 현병력
        "hx_hypertension": "현병력__고혈압",
        "hx_diabetes": "현병력__당뇨",
        "hx_dyslipidemia": "현병력__이상지질혈증",
        
        # 약물력
        "med_bp": "약물력__혈압약",
        "med_diabetes": "약물력__당뇨약",
        "med_lipid": "약물력__이상지질혈증약",
        "med_sleep": "약물력__수면제",
        "med_antidepressant": "약물력__항우울제",
        "med_anxiolytic": "약물력__항불안제",
        
        # 사회력
        "alcohol_freq": "사회력_술_월간 음주 횟수",
        "alcohol_amt": "사회력_술_1회당 음주량",
        "smoke_daily": "사회력_담배_일간 개피",
        "smoke_duration": "사회력_담배_총 흡연기간",
        "exercise_freq": "사회력_운동_주간 횟수",
        "exercise_time": "사회력_운동_1회당 평균 운동 시간",
        "exercise_intensity": "사회력_운동_운동 강도",
        
        # 여성력
        "mens_cycle": "여성력_여성력(가임기 여성 기준. 초경전, 임신, 폐경자 제외)_생리주기",
        "mens_regular": "여성력_여성력(가임기 여성 기준. 초경전, 임신, 폐경자 제외)_생리규칙성",
        "mens_duration": "여성력_여성력(가임기 여성 기준. 초경전, 임신, 폐경자 제외)_생리기간",
        "mens_amt": "여성력_여성력(가임기 여성 기준. 초경전, 임신, 폐경자 제외)_생리 양",
        "mens_pain": "여성력_여성력(가임기 여성 기준. 초경전, 임신, 폐경자 제외)_생리통강도",
        "mens_clot": "여성력_여성력(가임기 여성 기준. 초경전, 임신, 폐경자 제외)_생리혈 덩어리여부",
        "mens_color": "여성력_여성력(가임기 여성 기준. 초경전, 임신, 폐경자 제외)_생리혈 색",
        
        # 가족력
        "fam_hypertension": "가족력__고혈압",
        "fam_diabetes": "가족력__당뇨",
        "fam_heart": "가족력__심장병",
        "fam_stroke": "가족력__중풍",
        
        # 환자 현재 상태 - 식사
        "diet_freq": "환자 현재 상태-식변면한한열_식사 량_1일 식사횟수",
        "diet_regular": "환자 현재 상태-식변면한한열_식사 량_식사 규칙성",
        "diet_amount": "환자 현재 상태-식변면한한열_식사 량_1일 평균 식사량",
        "diet_speed": "환자 현재 상태-식변면한한열_식사시간_1회 평균식사시간",
        "digestion": "환자 현재 상태-식변면한한열_소화여부_소화정도",
        "appetite": "환자 현재 상태-식변면한한열_소화여부_입맛",
        
        # 대변
        "stool_freq": "환자 현재 상태-식변면한한열_대변_대변 횟수",
        "stool_color": "환자 현재 상태-식변면한한열_대변_대변 색",
        "stool_form": "환자 현재 상태-식변면한한열_대변_대변 굳기(형태)",
        "stool_discomfort": "환자 현재 상태-식변면한한열_대변_배변 후 불편감",
        "stool_residual": "환자 현재 상태-식변면한한열_대변_배변 후 잔변감(강도)",
        
        # 소변
        "urine_freq": "환자 현재 상태-식변면한한열_소변_1일 소변 횟수(야간뇨 포함)",
        "urine_night": "환자 현재 상태-식변면한한열_소변_야간뇨 횟수",
        "urine_color": "환자 현재 상태-식변면한한열_소변_소변 색",
        "urine_stream": "환자 현재 상태-식변면한한열_소변_소변 굵기(소변줄기)",
        "urine_discomfort": "환자 현재 상태-식변면한한열_소변_소변 후 불편감",
        "urine_residual": "환자 현재 상태-식변면한한열_소변_배뇨 후 잔뇨감(강도)",
        "urine_incontinence": "환자 현재 상태-식변면한한열_소변_유뇨, 요실금 빈도",
        
        # 수면
        "sleep_refresh": "환자 현재 상태-식변면한한열_수면상태_기상시 상쾌도",
        "sleep_hours": "환자 현재 상태-식변면한한열_수면상태_수면 시간",
        "sleep_depth": "환자 현재 상태-식변면한한열_수면상태_수면 깊이",
        "insomnia": "환자 현재 상태-식변면한한열_수면상태_불면 빈도",
        "dreams": "환자 현재 상태-식변면한한열_수면상태_꿈의 빈도 및 내용",
    },
    
    # 알레르기비염 symptom mappings (similar structure)
    "알레르기비염": {
        # 발현시점
        "onset": "알러지비염가상환자_O/S_알러지비염 발현시점",
        
        # 주증상
        "snot_sev": "알러지비염가상환자_알러지비염 주증 및 동반증상_콧물 량",
        "snot_color": "알러지비염가상환자_알러지비염 주증 및 동반증상_콧물 색",
        "nasal_congestion": "알러지비염가상환자_알러지비염 주증 및 동반증상_코막힘",
        "sneeze_intensity": "알러지비염가상환자_알러지비염 주증 및 동반증상_재채기(정도)",
        "sneeze_freq": "알러지비염가상환자_알러지비염 주증 및 동반증상_재채기(빈도)",
        "nose_itch": "알러지비염가상환자_알러지비염 주증 및 동반증상_코 가려움",
        
        # 악화 요인
        "aggravating_factors": "알러지비염가상환자_알러지비염 완화요인/악화요인_알러지비염 완화요인/악화요인",
        
        # 검사
        "nasal_exam": "알러지비염가상환자_검사_비경검사(점막이 부어있으면 안됨)",
        
        # 인구학적 정보 (same structure as 감기)
        "height_category": "인구학적 정보__키",
        "weight_category": "인구학적 정보__몸무게",
        "bmi_category": "인구학적 정보__체질량지수",
        "sex": "인구학적 정보__성별",
        ...
        # (Similar mappings for other categories...)
    }
}


def get_csv_symptom_key(disease_name: str, session_key: str) -> Optional[str]:
    """
    Get the CSV symptom key for a session state key.
    
    Args:
        disease_name: Name of the disease
        session_key: Session state variable name
    
    Returns:
        CSV symptom key or None if not found
    """
    disease_map = SYMPTOM_KEY_MAP.get(disease_name, {})
    return disease_map.get(session_key)
